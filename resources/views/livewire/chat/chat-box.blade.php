...
class="w-full overflow-hidden">
    ...
    <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b " >
        ...
        <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
            ...
            <div class="shrink-0">
                <img src="https://loremflickr.com/500/500/face-receiver?random={{ $selectedConversation->id }}" alt="User Avatar" class="h-9 w-9 lg:w-11 lg:h-11 rounded-full" />
                </div>
...
<x-avatar src="https://loremflickr.com/500/500/face-receiver?random={{ $selectedConversation->id }}" class="h-9 w-9 lg:w-11 lg:h-11" />
